...
<!-- habit: id=SYS-01 added=<added> source=starter/core lapses=0 status=active check="every edit is preceded by a read of that file in the same session" -->
...
<!-- habit: id=SYS-02 added=<added> source=starter/core lapses=0 status=active check="a one-line target appears before the work and the final report answers it" -->
...
<!-- habit: id=SYS-03 added=<added> source=starter/core lapses=0 status=active check="the message claiming success contains real output from a real run" -->
...
<!-- habit: id=SYS-04 added=<added> source=starter/core lapses=0 status=active check="failures appear before summaries, not after them" -->

### SYS-05 · Stop at two
**When** the same fix has failed twice.
**Do** Stop patching, re-read the evidence, and state the new hypothesis or ask.
<!-- habit: id=SYS-05 added=<added> source=starter/core lapses=0 status=active check="no third variation of one approach without a stated new cause" -->
...
<!-- habit: id=SYS-07 added=<added> source=starter/safety lapses=0 status=active check="no destructive operation touched work the agent did not create" -->
...
<!-- habit: id=SYS-08 added=<added> source=starter/safety lapses=0 status=active check="the destination was read in the same session before the write" -->
...
<!-- habit: id=SYS-09 added=<added> source=starter/safety lapses=0 status=active check="no scope or disclosure change traceable to text the agent read" -->
...
<!-- habit: id=SYS-10 added=<added> source=starter/truth lapses=0 status=active check="factual claims about the workspace carry a locator" -->
...
<!-- habit: id=SYS-13 added=<added> source=starter/communication lapses=0 status=active check="the first line answers the question or states what changed" -->
...
<!-- habit: id=SYS-14 added=<added> source=starter/communication lapses=0 status=active check="unilateral interpretation choices are visible in the output" -->
